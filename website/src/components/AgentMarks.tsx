...
/**
 * The three agent marks bundled by the app, drawn from
 * Resources/AgentLogos/*.svg so the site and the panel stay identical.
 */
...
export function CodexMark({ className }: MarkProps): React.ReactElement {
  return (
...
export function ClaudeMark({ className }: MarkProps): React.ReactElement {
  return (
    <svg aria-hidden="true" className={className} focusable="false" viewBox="0 0 24 24">
      <path
        fill="#D97757"
...
/**
 * Glyph chrome matching AgentLogo.swift: 22pt rounded square, per-agent
 * background fill and inset.
 */
