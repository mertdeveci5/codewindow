...
The production website uses PostHog for pageview/pageleave analytics, Web Vitals (LCP, CLS, FCP,
and INP), plus explicit, privacy-safe engagement events: `site_engaged`, `section_viewed`,
